        ...
        <Svg height={height} width={width} viewBox={viewBox} opacity={opacity}>
            <G xmlns="http://www.w3.org/2000/svg" id="Pokéball_1_">
                <G id="Colours">
                    ...
                    <Path id="Shadow_Down" fill="#DFDFDF"  d="M345.6,505.9c89.6-21,157.7-97.7,165.7-191.6h-53C453,399.5,408.3,471.7,345.6,505.9z"/>
                    <Path id="Center" fill="#FFFFFF" d="M347.1,297L347.1,297C347,297,347,297,347.1,297c-0.1-6.1-1.2-11.9-3.2-17.3    c-7-18.8-25.1-32.1-46.3-32.1s-39.3,13.4-46.3,32.1c-2,5.4-3.1,11.2-3.1,17.3c0,0,0,0,0,0h0.1c0,0,0,0,0,0    c0,6.1,1.1,11.9,3.1,17.3c7,18.8,25.1,32.1,46.3,32.1c21.2,0,39.3-13.4,46.3-32.1C346,309,347.1,303.1,347.1,297    C347.1,297,347.1,297,347.1,297z"/>
                    <Path id="Up" fill={fill || '#FF1C1C'} d="M297.7,213.2c40.4,0,74.1,28.6,82.1,66.6h134.4C504.7,169.2,412,82.5,299,82.5S93.4,169.2,83.9,279.7    h131.7C223.6,241.7,257.3,213.2,297.7,213.2z"/>
                    <Path id="Shadow_Up" fill={fillShadow || '#DF1818'} d="M458.3,279.7h55.8c-8.2-95.5-78.6-173.3-170.5-192.6C407.4,120.8,452.9,193.7,458.3,279.7z"/>
                </G>
...
export default IconSimplePokebola