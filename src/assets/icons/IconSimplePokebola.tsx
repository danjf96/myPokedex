        ...
        <Svg height={height} width={width} viewBox={viewBox} >
            <G xmlns="http://www.w3.org/2000/svg" id="Pokéball_1_">
                <G id="Colours">
                    ...
                    <Path id="Up" fill={fill} d="M297.7,213.2c40.4,0,74.1,28.6,82.1,66.6h134.4C504.7,169.2,412,82.5,299,82.5S93.4,169.2,83.9,279.7    h131.7C223.6,241.7,257.3,213.2,297.7,213.2z"/>
                    <Path id="Shadow_Up" fill={fillShadow} d="M458.3,279.7h55.8c-8.2-95.5-78.6-173.3-170.5-192.6C407.4,120.8,452.9,193.7,458.3,279.7z"/>
                </G>
